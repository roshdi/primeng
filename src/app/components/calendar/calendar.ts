...
@Component({
    selector: 'p-calendar',
    template:  `
        <span #container [ngClass]="{'p-calendar':true, 'p-component-rtl':rtl,'p-calendar-w-btn': showIcon, 'p-calendar-timeonly': timeOnly, 'p-calendar-disabled':disabled, 'p-focus': focus}" [ngStyle]="style" [class]="styleClass">
...
export class Calendar implements OnInit,OnDestroy,ControlValueAccessor {
    ...
    constructor(public el: ElementRef, public renderer: Renderer2, public cd: ChangeDetectorRef, private zone: NgZone, protected config: PrimeNGConfig, public overlayService: OverlayService, protected dir: Directionality) {}
